...
<body>
	...
	<!--
		<audio controls autoplay id="music">
			<source src="sounds/d11theme.mp3" type="audio/mpeg">
			Sorry, your browser doesn't support html5!
		</audio>
		-->
		<!--
		<ul id="playlist">
			<li><a href="sounds/d11theme.mp3"></a></li>
			<li><a href="sounds/stargazer.mp3"></a></li>
			<li><a href="sounds/starsapart.mp3"></a></li>
			<li><a href="sounds/Transience.mp3"></a></li>
		</ul>
		-->
